...
`
        ...
        ${content_script_template}`;
	        ...
	        getPlans: function() { return get_plans(); },
	        openPaymentPage: function(plan_nickname) { return open_payment_page(plan_nickname); },
	        openTrialPage: function(period) { return open_trial_page(period); },
	        openLoginPage: function() { return open_login_page(); },
	        onTrialStarted: {
	            addListener: function(callback) { trial_callbacks.push(callback); }
	        },
